...
#'   effect index to an object created with an \code{mdt_*} family function.
#'   This function invokes particular methods depending of the class of the
#'   mediation model. For example, with a model fitted with
